  ...
  $(document).ready(function() {
    ...
    if ($("#restroom_table").data("lat-near") === 47.6062095 && $("#restroom_table").data("long-near") === -122.3320708) {
      ...
      initialize = function() {
        ...
        return $(".restroom").each(function() {
          var a, b, marker, rrLatLng;
          a = $(this).data("lat");
          b = $(this).data("long");
      ...
      initialize = function() {
        var LatLngMarkerList, bounds, image, mapOptions, marker, myLatlng;
